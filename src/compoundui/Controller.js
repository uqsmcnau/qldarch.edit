...
Ext.apply(lore.ore.Controller.prototype, {
    ...
    */
    ...
    addFromGeonamesURLWithPrompt: function(){
        Ext.Msg.show({
            title : 'Load from Geonames URL',
            buttons : Ext.MessageBox.OKCANCEL,
            msg : 'Please enter the URL of the Geonames Resource:',
            scope: this,
            fn : function(btn, theurl) {
                if (btn == 'ok') {
                    lore.ore.controller.addFromGeonamesURL(theurl, true);
                }
            },
            prompt : true
        });
    ...
    /**
     * Add a resource to the Resource Map for an entry in Corbicula.
     * @param {} uri
     */
    addFromGeonamesURL: function(uri, createNew){ 
    	var params = {};
    ...
    setLockCompoundObject: function(locked){
        ...
        if (lore.ore.ui.grid.getView().grid) {
